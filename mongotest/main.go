...
func init() {
	host = flag.String("H", "10.255.48.233:27017", "The host and port of the mongod instance you wish to connect to")
	dbname = flag.String("db", "VTMan", "The output file that will be written to")
	user = flag.String("user", "", "The user you wish to authenticate with")
	pass = flag.String("pass", "", "The pass you wish to authenticate with")
	col = flag.String("c", "LogCallBot", "The collection you wish to output")
